...
static const uint32 ItemQualityColors[MAX_ITEM_QUALITY] =
{
	0xff9d9d9d,        // GREY
	0xffffffff,        // WHITE
	0xff1eff00,        // GREEN
...
static uint32 const CREATURE_TYPEMASK_HUMANOID_OR_UNDEAD = (1 << (CREATURE_TYPE_HUMANOID - 1)) | (1 << (CREATURE_TYPE_UNDEAD - 1));
static uint32 const CREATURE_TYPEMASK_MECHANICAL_OR_ELEMENTAL = (1 << (CREATURE_TYPE_MECHANICAL - 1)) | (1 << (CREATURE_TYPE_ELEMENTAL - 1));
...
inline uint8 ClassByQuestSort(uint32 QuestSort);
inline uint8 ClassByQuestSort(uint32 QuestSort)
{
	switch (QuestSort)
	{
...
inline uint32 SkillByQuestSort(uint32 QuestSort);
inline uint32 SkillByQuestSort(uint32 QuestSort)
{
	switch (QuestSort)
	{
...
typedef enum BattleGroundTypeId
{
